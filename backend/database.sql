...
(1, 1, 'CM2020', 'What is 2+2?', '{"correct":"4","options":["3","4","5"]}', 1, 'http://example.com/video/1', 10, 2, 15, 5),
(2, 2, 'CM2020', 'What is the capital of France?', '{"correct":"Paris","options":["Paris","London","Berlin"]}', 2, 'http://example.com/video/2', 20, 1, 20, 10),
(17, 1, 'CM2020', 'What is the capital of Hungary?', '{"correct":"Budapest","options":["Brussels","Budapest","Lisbon"]}', 2, 'http://example.com/video/17', 170, 17, 95, 85);
